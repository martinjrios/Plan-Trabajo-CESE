...
\titulo{Firmware para dispositivo de seguimiento vehicular} 
...
\cliente{Cristian Valloni}
\empresaCliente{RSI Group S.A.}
...
\fechaFINALTrabajo{21 de junio de 2022}	%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el desarrollo e implementación de un sistema de control y localización de un precinto electrónico para monitoreo de cargas y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y u\$d 5200, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
%			\item El equipo debe tener un indicador luminoso para indicar el estado del precinto (Estado abierto $\rightarrow$ indicador encendido; estado cerrado $\rightarrow$ indicador apagado).
%			\item El equipo debe tener un indicador luminoso para indicar el estado de la red Wi-Fi (Wi-Fi encendido $\rightarrow$ indicador encendido; Wi-Fi apagado $\rightarrow$ indicador apagado).
%			\item El equipo debe poder apagar y encender la bobina de un electroimán con un consumo de 1 A y una tensión de alimentación de 5 V.
%			\item El equipo debe tener un pulsador para encender la comunicación Wi-Fi.
%			\item El equipo 
