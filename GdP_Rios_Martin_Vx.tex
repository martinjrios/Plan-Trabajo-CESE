...
\director{Esp. Ing. Mauro Oscar Moreyra}
\pertenenciaDirector{MPF CABA} 
...
\fechaFINALTrabajo{13 de julio de 2022}	%Fecha de defensa pública del trabajo final
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el desarrollo e implementación de un sistema de control y localización de un precinto electrónico para monitoreo de cargas y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y U\$D 7128, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
%\hline
%\rowcolor[HTML]{C0C0C0} 
%Revisión & \multicolumn{1}{c|}{\cellcolor[HTML]{FBFB7B}Detalles de los cambios realizados} & Fecha      \\ \hline
%0      & Creación del documento                                 & 24/06/2021 \\ \hline
%\end{tabularx}
%\end{table}
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=1.5\textwidth, angle=90]{./Figuras/gantt.pdf}
